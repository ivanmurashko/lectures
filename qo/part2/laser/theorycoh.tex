...
теореме Хинчина-Винера (см. приложение \ref{AddHinchin}) будет
...
\int_0^{2 \pi}
d \theta
\frac{\partial^2}{\partial^2 \theta}P\left(r
e^{i \theta}, t\right) e^{i \theta}.
...
\int_0^{2 \pi}
d \theta
\frac{\partial^2}{\partial^2 \theta}P e^{i \theta} = 
