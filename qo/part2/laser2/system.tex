...
%% воспользоваться уравнением Гейзенберга (\ref{eqLaserHaizenberg1}) подставив в него
%% гамильтониан лазерной системы (\ref{eqLaserHaizenberg2}). Поскольку
...
%% В (\ref{eqLaserHaizenberg12}) выражено через добротность резонатора
...
Объединив полученные нами уравнения (\ref{eqLaserHaizenbergA}), 
