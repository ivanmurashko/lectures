...
set label "r'" at -1.8,3.2
set label "r" at -1.8,-4.8


set terminal pdf
set output './picellipticsumeq2.pdf'
set object circle at first 1,2 radius char 0.25
set object circle at first -1,4 radius char 0.25
set object circle at first -1,-4 radius char 0.25
splot [-10:10][-10:10] f(x,y), line1(x,y), line2(x,y)

set terminal eps
set output './picellipticsumeq2.eps'
set object circle at first 1,2 radius char 0.25
set object circle at first -1,4 radius char 0.25
set object circle at first -1,-4 radius char 0.25
splot [-10:10][-10:10] f(x,y), line1(x,y), line2(x,y)
