...
\ref{thm:lagrange}), \index{теорема Лагранжа} которые могут 
...
произвольным полем (см. определение \ref{def:field}), \index{Поле}
...
(см. теор. \ref{thm:lagrange}) \index{теорема Лагранжа} у нее есть
