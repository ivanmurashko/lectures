...
называется декогеренцией.\index{Декогеренция}
...
Адамара по отношению к исходному \index{Преобразование Адамара}:
\begin{eqnarray}
...
\mbox{ с. }$ \index{Декогеренция!скорость}
...
Рассмотрим вначале чистые состояния \index{Чистое состояние}
...
измерения. Смешанные состояния \index{Смешанное состояние}
