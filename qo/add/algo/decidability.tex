...
\begin{proof}
Assume that we have a turing machine $M_P$ that can select a
nontrivial property. I.e. it can separate all languages into 2
sets. The first one with languages satisfy the property ($M_P$
