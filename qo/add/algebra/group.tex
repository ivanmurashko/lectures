...
\begin{theorem}[О числе порождающих элементов циклической группа
    порядка $p$]
\myref{def:add:algebra:cyclic_group}{Циклическая группа} порядка $p$,
где $p$ - простое число имеет $p$ порождающих элементов
\begin{proof}
TBD
\end{proof}
\label{thm:add:algebra:cyclic_group}
\end{theorem}
