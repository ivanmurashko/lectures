...
2 является генератором группы $\mathbb{F}_{59}$, т.е. можно
рассмотреть задачу определения $x$ такого, что 
\[
2^x \equiv 14 \mod 59.
\]
...
f'(x_1, x_2) = 
\begin{cases}
1, \mbox{ если } 14^{x_1} 2^{x_2} = 3 \mod 59 \\
1, \mbox{ если } 14^{x_1} 2^{x_2} \ne 3 \mod 59 
\end{cases}
\]
изображен на \autoref{fig:part4:quantcomp:dl4}. Самый нижний максимум
имеет координаты $j_1 = 46, j_2 = 3.5$ откуда имеем для оценки 
\[
x \approx \frac{46}{3.5} \approx 13.14.
\]
