...
изображено на \autoref{figQuantCompQuantFourier2d}. Действительно если
на входе имеем (см. \eqref{eqPart4QuantCompShorQuantFourierSeries})
\begin{eqnarray}
...
\nonumber
\end{eqnarray}
С учетом того что на выходе имеем
\[
...
e^{-i \omega_1 k_{1} j_{1} - i \omega_2 k_{2} j_{2}}
x_{k_1}^{(1)}x_{k_2}^{(2)} =
\nonumber \\
...
\nonumber
\end{eqnarray}
что является двумерным преобразованием Фурье от исходного двумерного
сигнала
\[
\ket{x} = 
