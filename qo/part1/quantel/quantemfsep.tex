...
\left(\hat{a}_k \hat{a}_k^{\dag} + \hat{a}_k^{+} \hat{a}_k\right).
\]

Воспользовавшись коммутационными соотношениями
\[
\left[\hat{a}, \hat{a}^{\dag} \right] = 1, \quad
\hat{a} \hat{a}^{\dag} - \hat{a}^{+}\hat{a} = 1, \quad
\hat{a} \hat{a}^{\dag} = \hat{a}^{+}\hat{a} + 1,
\]
имеем
\(
...
\begin{eqnarray}
  ...
  \left(\hat{a}_k^{\dag} \hat{a}_k + \hat{a}_k \hat{a}_k^{+}\right)
  =
  \nonumber \\
  =
  \sum_{(k)}
  ...
  \frac{\hat{a}_k^{\dag} \hat{a}_k + \hat{a}_k \hat{a}_k^{+}}{2}
  =
