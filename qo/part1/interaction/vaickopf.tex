%% -*- coding:utf-8 -*- 
\section{Спонтанное излучение. Приближение Вайскопфа-Вигнера.}
...
Переходя в (\ref{eqCh2Vaiskopf8pre}) от $k$ к $\omega$ с помощью соотношений 
\begin{equation}
...
Из (\ref{eqCh2Vaiskopf10}) следует, что $\Gamma$ характеризует
