...
(\ref{eqCh2_93}) можно представить в виде:  
%FIXME!!! check it
\begin{eqnarray}
...
(\ref{eqCh1_modenumber_kvazy_contig}) 
\[
...
Уравнение (\ref{eqCh2_99}) имеет тот же вид, что и уравнение
(\ref{eqCh2_64}), полученное ранее. Уравнения 
...
\]
Используя свойства (\ref{eqCh2_8}) - (\ref{eqCh2_task1}) операторов 
