...
$\left|\psi\left(r, 0\right)\right>_I = \ket{b, n + 1}_I$ , т. е. 
...
$\ket{a, n}_I$,  т.е. атом находится в верхнем
...
Воспользовавшись \eqref{eqCh2_Psi_inter} в левой части выражения
...
$\bra{a, n}$ и $\bra{b, n + 1}$.  Учитывая свойства
...
\end{equation}
На \autoref{fig:part1:rabi} изображены зависимости вероятностей 
...
соответствующее одному фотону в моде. \rindex{фотон} При больших $n$ эти два
...
\rindex{Переменный Штарк - эффект}
