...
\begin{equation}
C_{a,n}\left(t\right) = -i \sin\left(g \sqrt{n + 1} t\right), \quad
C_{b, n + 1}\left(t\right) = \cos\left(g \sqrt{n + 1} t\right), 
\end{equation}
где $g\sqrt{n + 1}$ - частота Раби в квантовом случае. Для случая
излучения из начальных условий ($C_{a,n}\left(0\right) = 1$,
$C_{b,n+1}\left(0\right) = 0$) имеем $A = 0$, $B = 1$, следовательно, 
\begin{equation}
C_{a,n}\left(t\right) = \cos\left(g \sqrt{n + 1} t\right), \quad
C_{b, n + 1}\left(t\right) = -i \sin\left(g \sqrt{n + 1} t\right), 
\end{equation}
...
В полуклассическом выражении частота Раби равна 
