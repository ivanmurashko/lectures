...
\begin{eqnarray}
G^{(2)} = \frac{\left<\hat{a}^{\dag}\hat{a}^{+}\hat{a}\hat{a}\right>}
{\left<\hat{a}^{\dag}\hat{a}\right>^2} = 
\nonumber \\
= 
\frac{\left<\hat{a}^{\dag}\hat{a}\left(\hat{a}^{+}\hat{a} - 1\right)\right>}
{\left<\hat{a}^{\dag}\hat{a}\right>^2} = 
...
В классическом случае $\left<\hat{a}^{\dag}\hat{a}\right> =
...
Из \eqref{eqPart3_Nonclass_Nonclass6} следует, что $G^{(2)}$ может
...
\begin{equation}
\left<\hat{a}^{\dag}\hat{a}^{+}\hat{a}\hat{a}\right> -
...
\begin{eqnarray}
  \left<\hat{a}^{\dag}\hat{a}^{+}\hat{a}\hat{a}\right> = Sp \left(
  \hat{a}^{\dag}\hat{a}^{+}\hat{a}\hat{a} \rho \right)=
  \nonumber \\
  =
  \sum_n \left<n\right|\left(\hat{a}^{\dag}\hat{a}^{+}\hat{a}\hat{a}
