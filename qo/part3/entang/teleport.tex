...
\]
\index{фотон!перепутанное состояние}Имеется также источник перепутанных фотонов $S$, который излучает пары
...
%%   \left|\psi\right>_{123} = \left|\psi\right>_1 \left|\psi\right>_{23} = 
%%   \nonumber \\
%%   = \left|\psi^{-}\right>_{12} \frac{\alpha\left|x\right>_3 + \beta\left|y\right>_3}{2} + 
%%   \nonumber \\
%%   + 
%%   \left|\psi^{\dag}\right>_{12} \frac{- \alpha\left|x\right>_3 + \beta\left|y\right>_3}{2} +
%%   \nonumber \\
%%   + 
%%   \left|\phi^{\dag}\right>_{12} \frac{- \beta\left|x\right>_3 + \alpha\left|y\right>_3}{2} +
%%   \nonumber \\
%%   +
%%   \left|\phi^{-}\right>_{12} \frac{\beta\left|x\right>_3 + \alpha\left|y\right>_3}{2}.
%%   \nonumber
%% \end{eqnarray}
...
%% $\alpha\left|x\right>_3 + \beta\left|y\right>_3$, то есть произойдет как бы телепортация фотона 1 к Бобу.
